#!/bin/bash
 ...
 qsub -cwd -q ibm-nehalem.q -b y ./tema2_neopt /export/asc/tema2/input > timeNeopt
 ...
 qsub -cwd -q ibm-nehalem.q -b y ./tema2_opt_m /export/asc/tema2/input > timeOpt
 ...
 qsub -cwd -q ibm-nehalem.q -b y ./tema2_blas /export/asc/tema2/input > timeBlas
